      ...
      this.service.getLastDate(this.regid, this.org.oid).subscribe(
        result => {
          ...
          if (this.org.oid === '0') {
            ...
            this.info_message = 'Таны нэвтрэх эрхийг цахим орчинд баталгаажуулах боломжгүй тул . өөрт ойр байрлах Нийгмийн даатгалын хэлтэст хандаж нэвтрэх эрхээ баталгаажуулах боломжтой';
